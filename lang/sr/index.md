...
Ako je verzija softvera MAJOR.MINOR.PATCH, povećajte:

1. MAJOR verziju ako dolazi do nekompatibilnih promena API-a,
1. MINOR verziju ako se dodaje funkcionalnost koja je kompatibilna unazad
   (sa prethodnom verzijom), i
1. PATCH verziju ako se popravljaju bug-ovi na način koji je kompatibilan
   sa prethodnom verzijom.

Dodatne oznake za pre-izdanja (pre-release) softvera i informacije o build-u se mogu koristiti kao proširenje MAJOR.MINOR.PATCH formata.
